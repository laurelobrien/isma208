...
class TypoAutomata {
  ...
  //initialize as generation 0 with seed state
  void init() {
    //for all indices in currentGen[]
    for (int i = 0; i < currentGen.length; i ++) {
      currentGen[i] = allBlocks[int(random(allBlocks.length/2))]; //assign WoodBlock object with .letter "a"
    }
  ...
  WoodBlock applyRules(WoodBlock a, WoodBlock b, WoodBlock c) {
    //re-assign ruleSet with the same structure but re-randomized pulls from array lists
    WoodBlock[] ruleSet = {ascendMatches.get(int(random(ascendMatches.size()))), descendMatches.get(int(random(descendMatches.size()))), 
                         counterMatches.get(int(random(counterMatches.size()))), descendMatches.get(int(random(descendMatches.size()))), 
                         ascendMatches.get(int(random(ascendMatches.size()))), ascendMatches.get(int(random(ascendMatches.size()))), 
                         descendMatches.get(int(random(descendMatches.size()))), ascendMatches.get(int(random(ascendMatches.size())))};
